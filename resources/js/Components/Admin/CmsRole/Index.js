...
function Index()
{
    ...
    const bulkDelete = async (slugs) => {
        let admin_route = window.api.delete_cms_role;
        ...
        if( response.code != 200 ){
          ...
          let updatedRoles = roles.filter( (role) => {
              return slugs.indexOf(role.slug) == -1
          })
    ...
    let columns = [
        ...
        },
        {
          ...
          action_cb: ( record ) => {
            return(
              <>
                  <Link className='btn btn-xs btn-primary' to={ window.constants.base_path + `admin/cms-roles/edit/${record.slug}` }><i className='fa fa-pencil'></i></Link>
                ...
                <div className="card">
                    <div className="card-header card-default">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <Link className="btn btn-info pull-right" to={window.constants.base_path + 'admin/cms-roles/add'}>Add Cms Role</Link>
                            </div>
                        </div>
                    </div>
                    <div className="card-body">
                        <div className='row'>
                            <div className='col-md-12'>
                              <DataTable columns={columns} config={config} data={ roles } />
                            </div>
                            <div className='col-md-12'>
